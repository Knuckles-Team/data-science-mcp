...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/data-science-mcp"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in data-science-mcp
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in data-science-mcp but are NOT registered "
