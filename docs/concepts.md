...
| `CONCEPT:DS-AHE.trainer.concept-5` | Benchmark Evaluation | `trainers/eval_hooks.evaluate_benchmarks` — LightEval scoring alongside the AHE-3.1 reliability suite |
